...
static Move moveCandidates58[] = {{"배리어", TYPE_PSYCHIC, MOVE_SPECIAL, 0, STAT_DEF, 2}, {"염동력", TYPE_PSYCHIC, MOVE_SPECIAL, 50, STAT_NONE, 0}, {"빛의장막", TYPE_PSYCHIC, MOVE_SPECIAL, 0, STAT_NONE, 0}, {"연속뺨치기", TYPE_NORMAL, MOVE_PHYSICAL, 15, STAT_NONE, 0}, {"요가포즈", TYPE_PSYCHIC, MOVE_SPECIAL, 0, STAT_ATK, 1}, {"대타출동", TYPE_NORMAL, MOVE_PHYSICAL, 0, STAT_NONE, 0}};
